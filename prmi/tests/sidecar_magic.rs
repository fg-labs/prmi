...
use prmi::sidecar::magic::{FORMAT_VERSION, L1_MAGIC, L2_MAGIC, META_MAGIC, SA_MAGIC};

#[test]
fn magics_match_spec_hex() {
    assert_eq!(META_MAGIC, "PRMIv1");
    assert_eq!(FORMAT_VERSION, 1); // bumping the on-disk format must fail this test
